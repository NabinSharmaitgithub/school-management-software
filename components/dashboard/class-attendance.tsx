...
import { studentsInClass, attendanceFor, setAttendance } from "@/lib/data";
import { Field, GlassButton, Select } from "@/components/ui";
...
/**
 * Attendance marking grid for a single class: date picker, mark-all,
 * per-student status rows and save. Parents handle class selection / scope.
 */
