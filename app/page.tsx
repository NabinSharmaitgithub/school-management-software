    ...
    <main className="relative min-h-screen flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-[420px] relative z-10">
        <div className="glass-panel p-8">
          ...
          <div className="flex p-1 bg-white/40 rounded-full mb-8 border border-white/60">
            {ROLES.map((r) => (
              <button
                key={r}
                type="button"
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="relative">
                ...
                <input
                  id="email"
                  type="text"
                  className="glass-input w-full pl-10 pr-4 py-2.5 rounded-lg text-sm placeholder:text-on-surface/40"
            ...
            <div>
              <label className="block text-xs font-semibold text-on-surface/80 mb-1.5 ml-1" htmlFor="password">
                Password
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="glass-input w-full pl-10 pr-10 py-2.5 rounded-lg text-sm placeholder:text-on-surface/40"
                  placeholder="••••••••"
                  value={password}
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <a href="/forgot-password" className="text-xs font-medium text-primary hover:text-tertiary transition-colors">
                Forgot password?
              </a>
            </div>

            {error && (
              <p className="text-xs text-error bg-red-50/70 border border-red-200 rounded-lg px-3 py-2">
                {error}
              </p>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="glass-btn-primary w-full py-3 rounded-lg text-white font-semibold text-base mt-6 flex items-center justify-center gap-2 disabled:opacity-60"
            >
